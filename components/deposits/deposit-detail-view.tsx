...
type PayoutDraft = { paymentDate: string; paymentFrom: string; paymentUpto: string; principalPayment: string; interestPayment: string; notes: string; };
